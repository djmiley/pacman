...
const text = ['Pushing yourself up from the floor, you check the room for a towel. A quick scan turns up no options for removing the dark gel from your hand.',
